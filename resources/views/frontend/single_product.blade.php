            ...
            <div class="col-lg-6">
                <div class="product-single-img">
                    <div class="product-active owl-carousel">
                        <div class="item">
                            <img src="{{ url('/img/thumbnail/') }}/{{ $product->product_thumbnail }}" alt="{{ $product->product_name }}">
                        </div>
                        @foreach (App\ProductGallery::where('product_id',$product->id)->get() as $img )


                        <div class="item">
                            <img src="{{ url('img/gallery').'/'.$img->product_gallery }}" alt="{{ $product->product_name }}">
                        </div>
                        @endforeach
...
<div class="featured-product-area">
    <div class="container">
        ...
        <div class="row">
            @foreach ($related_product as $reltd_product )


            <div class="col-lg-3 col-sm-6 col-12">
                <div class="featured-product-wrap">
                    <div class="featured-product-img">
                        <img src="{{ url('img/thumbnail').'/'.$reltd_product->product_thumbnail }}" alt="">
                    </div>
                    <div class="featured-product-content">
                        <div class="row">
                            <div class="col-7">
                                <h3><a href="{{ route('SingleProduct',$reltd_product->slug) }}">{{ $reltd_product->product_name }}</a></h3>
                                <p>${{ $reltd_product->product_price }}</p>
                            </div>
