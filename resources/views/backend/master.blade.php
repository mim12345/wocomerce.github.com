                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li><a href="{{ url('view-category-list') }}">View Category</a></li>
                                    <li><a href="{{ url('/add-subcategory') }}">Add Sub Category </a></li>
                                    <li><a href="{{ url('view-subcategory-list') }}">View Sub Category</a></li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li><a href="{{ url('view-product-list') }}">Product List</a></li>
